// Removed import, relying on global THREE object from CDN
...
function initBeams(containerId, options = {}) {
    ...
    scene.background = new THREE.Color(0x000000); // Or transparent if you prefer
    ...
    group.add(dirLight); // Add to group to rotate with beams if needed, or scene if not
    ...
    function animate() {
        ...
        beamMaterial.uniforms.time.value += 0.1 * delta; // Adjust speed multiplier as needed to match original
